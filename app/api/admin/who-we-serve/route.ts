...
export async function POST(request: Request) {
  ...
  try {
    ...
    console.error("Create who-we-serve entry error:", err)
...
export async function PUT(request: Request) {
  ...
  try {
    ...
    console.error("Update who-we-serve entry error:", err)
...
export async function DELETE(request: Request) {
  ...
  try {
    ...
    await withRls(session!.userId, (tx) => tx.whoWeServe.delete({ where: { id } }))
    return NextResponse.json({ success: true })
  } catch (err) {
    console.error("Delete who-we-serve entry error:", err)
