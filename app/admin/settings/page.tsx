        ...
        <CardContent>
          <SiteSettingsForm
            initial={{
              ...
              inquiry_receiver_email: resolved.emailSettings.inquiryReceiverEmail || settings?.contactEmail || "info@absonsolutions.com",
              smtp_sender_email: resolved.emailSettings.smtpSenderEmail || "",
              smtp_host: resolved.emailSettings.smtpHost || "",
              smtp_port: resolved.emailSettings.smtpPort || 587,
              smtp_encryption: resolved.emailSettings.smtpEncryption || "tls",
              smtp_user: resolved.emailSettings.smtpUser || "",
              smtp_pass: resolved.emailSettings.smtpPass || "",
              contact_form_mode: resolved.emailSettings.contactFormMode || "internal",
              external_form_embed_html: resolved.emailSettings.externalFormEmbedHtml || "",
              ...
              nav_items: JSON.stringify({
                ...
                footerMeta: {
                  ...
                  emailSettings: resolved.emailSettings,
                },
              }),
