...
const SECTION_PRESET_OPTIONS: SectionPresetOption[] = [
  ...
  },
  {
    id: "royal-blue",
    label: "Royal Blue",
    description: "Brand gradient CTA section matching the home page callout style.",
    background: "var(--brand-gradient-strong)",
    textColor: "color-mix(in oklab, var(--primary-foreground) 90%, transparent)",
    headingColor: "var(--primary-foreground)",
    linkColor: "var(--primary-foreground)",
    accentColor: "color-mix(in oklab, var(--primary-foreground) 85%, transparent)",
    borderColor: "color-mix(in oklab, var(--primary-foreground) 35%, transparent)",
  },
  {
    id: "frosted-steel",
    label: "Frosted Steel",
