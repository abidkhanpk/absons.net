      ...
      heroSlides: JSON.stringify([
        {
          ...
          subtitle: "Innovative software and training solutions tailored to your needs.",
        ...
        },
        {
          ...
          subtitle: "Professional vibration analysis training with certified experts.",
        ...
        },
        {
          ...
          subtitle: "From education to industry, we deliver results that matter.",
          ctaText: "Contact Us",
          ctaHref: "/contact",
