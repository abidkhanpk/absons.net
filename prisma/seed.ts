  ...
  const products = [
    {
      ...
      title: "Zakat Assistant (Free)",
      description: "A free assistant to help calculate Zakat accurately with a simple and guided workflow.",
      icon: "BookOpen",
      imageUrl: "https://images.unsplash.com/photo-1593113598332-cd59a93f7b9e?auto=format&fit=crop&w=1200&q=80",
      linkUrl: "https://zakatassistant.absons.net",
      isActive: true,
      displayOrder: 1,
    },
    {
      ...
      title: "Order Pilot",
      description: "Order and workflow management platform for streamlined operations and team coordination.",
      icon: "Activity",
      imageUrl: "https://images.unsplash.com/photo-1556740749-887f6717d7e4?auto=format&fit=crop&w=1200&q=80",
      linkUrl: "https://orderpilot.absons.net",
      isActive: true,
      displayOrder: 2,
    },
    {
      ...
      title: "MMS Urdu",
      description: "An Urdu-focused platform designed for accessible content management and communication.",
      icon: "School",
      imageUrl: "https://images.unsplash.com/photo-1513258496099-48168024aec0?auto=format&fit=crop&w=1200&q=80",
      linkUrl: "https://mmsurdu.pk",
      isActive: true,
      displayOrder: 3,
    },
    {
      id: "ab0f50f8-95fd-4c06-b20b-9db08ab9b0dc",
      title: "AIMS",
      description: "A management suite built for institution operations, tracking, and administrative control.",
      icon: "GraduationCap",
      imageUrl: "https://images.unsplash.com/photo-1454165804606-c3d57bc86b40?auto=format&fit=crop&w=1200&q=80",
      linkUrl: "https://aims.absons.net",
      isActive: true,
      displayOrder: 4,
    },
    {
      id: "7be5ca30-6895-4528-95cb-5de6a1f5fbb3",
      title: "Cookie Swtich Chrome Extension (Free)",
      description: "A free Chrome extension to quickly switch cookies for testing and multi-account workflows.",
      icon: "Package",
      imageUrl: "https://images.unsplash.com/photo-1461749280684-dccba630e2f6?auto=format&fit=crop&w=1200&q=80",
      linkUrl: "https://absons.net/dl/cookieswitch.zip",
      isActive: true,
      displayOrder: 5,
    },
  ]
